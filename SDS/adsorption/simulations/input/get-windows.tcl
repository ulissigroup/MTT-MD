...
set initial_distance 4
set final_distance 20


## load files here

mol new ../SDS_graphene_wb.psf
mol addfile ../output/cntabf_z.dcd waitfor all

# Load trajectory file to parse trajectories
# make coordinate files for each window
set traj [open ../output/cntabf_z.colvars.traj r]
set data [read $traj]
